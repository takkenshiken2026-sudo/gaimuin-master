...
from tools.archive.hub_collapse_angles import (
...
from tools.archive.hub_diversify_content import TITLE_SUFFIXES
...
def _slug_stem(slug: str) -> str:
    from tools.archive.hub_collapse_angles import BATCH_SLUG_PREFIX, BATCH_SLUG_SUFFIX
