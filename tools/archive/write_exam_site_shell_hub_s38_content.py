...
COMPARISON_TOPICS = [
    ("s38-fukushu-cmp", "復習の比較", R),
    ("s38-hub-diff", "ハブ活用の違い", O),
    ("s38-fukushu-matome", "復習の整理", R),
    ("s38-hub-point", "ハブ活用の要点", O),
    ("s38-fukushu-taihi", "復習の対比", R),
    ("s38-hub-kubun", "ハブ活用の区分", O),
    ("s38-fukushu-tejun", "復習の手順", R),
    ("s38-hub-seido", "ハブ活用の制度", O),
    ("s38-fukushu-unyo", "復習の運用", R),
    ("s38-hub-hantei", "ハブ活用の判定", O),
]
...
COMPARISONS_ADD = [
    cmp(
        ...
        f"{title}｜試験対策 S38",
        "S38では復習・ハブ活用を中心に整理します。比較表で軸を先に固定してください。" + _OFFICIAL,
        "復習;ハブ活用;条件文の主語確認",
        ...
        [
            ...
            ("S37との違いは？", "S37は基礎整理、S38は復習・ハブ活用の深掘りです。"),
...
NUMBER_TOPICS = [
    ("s38-fukushu-num", "復習の数値", R),
    ("s38-hub-cycle", "ハブ活用の周期", O),
    ("s38-fukushu-meyasu", "復習の目安", R),
    ("s38-hub-freq", "ハブ活用の頻度", O),
    ("s38-fukushu-ratio", "復習の比率", R),
    ("s38-hub-time", "ハブ活用の時間", O),
    ("s38-fukushu-count", "復習の回数", R),
    ("s38-hub-kijun", "ハブ活用の基準", O),
    ("s38-fukushu-haibun", "復習の配分", R),
    ("s38-hub-check", "ハブ活用の確認", O),
]
...
NUMBERS_ADD = [
    num(
        ...
        f"{title}｜試験対策 数値S38",
        "S38の数値は復習・ハブ活用と条件のセットで覚えると得点が安定します。" + _OFFICIAL,
...
MISTAKE_TOPICS = [
    ("s38-kon-fukushu-kon", "復習の混同", R),
    ("s38-kon-hub-gokai", "ハブ活用の誤認", O),
    ("s38-kon-fukushu-reverse", "復習の逆転", R),
    ("s38-kon-hub-omit", "ハブ活用の省略", O),
    ("s38-kon-fukushu-blind", "復習の盲信", R),
    ("s38-kon-hub-over", "ハブ活用の過剰", O),
    ("s38-kon-fukushu-noconf", "復習の未確認", R),
    ("s38-kon-hub-nouse", "ハブ活用の未使用", O),
    ("s38-kon-fukushu-skip", "復習の放置", R),
    ("s38-kon-hub-zero", "ハブ活用のゼロ", O),
]
...
MISTAKES_ADD = [
    mis(
        ...
        "復習・ハブ活用は名称が似るため、主語と時点の読み飛ばしが起きやすい。",
        [
        ...
        f"{title}｜試験対策 誤答S38",
        "S38の誤答は復習・ハブ活用の読み落としが中心です。誤答型を記録し、比較表へ戻って根拠を再確認してください。" + _OFFICIAL,
