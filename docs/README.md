...
6. **[seo-article-guidelines.md](./seo-article-guidelines.md)** … 記事・用語・色・内部リンク・公開前チェック（**正本**）
   ...
   - アフィリエイト記事（他サイト実装手順）: **[affiliate/multi-site-affiliate-workflow.md](./affiliate/multi-site-affiliate-workflow.md)** → [affiliate/README.md](./affiliate/README.md)
...
9b. [.cursor/rules/affiliate-banner.mdc](../.cursor/rules/affiliate-banner.mdc) … アフィリエイト用バナー（一覧カード・記事内サムネ・画像）
